...
function [VFAmatrix, inlet_specs_HC0, dmix_props, jmix_props, amix_props, diesel_blend_max, jet_blend_max, auto_blend_max] = FuelCriteria_noseps(VFA_molfracs) 
...
% Properties of initial fuel mixture.

inlet_specs_HC0 = HCmix(Alkmatrix,PVPs(:,46:58));
...
secondary_meetspecs(1,:) = checkspecs(inlet_specs_HC_diesel,SpecLimits(:,:,1));
secondary_meetspecs(2,:) = checkspecs(inlet_specs_HC_jet,SpecLimits(:,:,2));
secondary_meetspecs(3,:) = checkspecs(inlet_specs_HC_gasoline,SpecLimits(:,:,3));
...
if Neat_diesel == 1
    ...
    start_frac = 0;
    [diesel_blend_max, dmix_props, dFailedProp, dHiLo] = Fuel_Blender(inlet_specs_HC_diesel, petro_props(1,:), SpecLimits(:,:,1), start_frac,"hydrocarbon","Diesel",Alkmatrix);
...
if Neat_jet == 1
    ...
    start_frac = 0;
    [jet_blend_max, jmix_props, jFailedProp, jHiLo] = Fuel_Blender(inlet_specs_HC_jet, petro_props(2,:), SpecLimits(:,:,2), start_frac,"hydrocarbon","Jet",Alkmatrix);
...
if Neat_auto == 1
    ...
    start_frac = 0;
    [auto_blend_max, amix_props, aFailedProp, aHiLo] = Fuel_Blender(inlet_specs_HC_gasoline, petro_props(3,:), SpecLimits(:,:,3), start_frac,"hydrocarbon","Gasoline",Alkmatrix);
